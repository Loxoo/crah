...
;(function (global, factory) {
    ...
    var defaultLocaleMonths = 'Janvier_Février_Mars_Avril_Mai_Juin_Juuillet_Aout_Septembre_Octobre_Novembre_Decembre'.split('_');
    function localeMonths (m, format) {
        return isArray(this._months) ? this._months[m.month()] :
            this._months[MONTHS_IN_FORMAT.test(format) ? 'format' : 'standalone'][m.month()];
    }

    var defaultLocaleMonthsShort = 'Jan_Fev_Mar_Avr_Mai_Jun_Jul_Aou_Sep_Oct_Nov_Dec'.split('_');
